...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HttpUtils = exports._currentAllyPage = exports._currentEnemyPage = exports._wrapperDivPositions = void 0;
const _ = __webpack_require__(20);
const pokemon_stat_1 = __webpack_require__(5);
const pokenode_ts_1 = __webpack_require__(9);
const update_allies_div_message_1 = __webpack_require__(21);
const update_enemies_div_message_1 = __webpack_require__(22);
function _createPokemonCardDiv(cardclass, cardId, pokemon) {
    ...
    const opacitySlider = _createOpacitySliderDiv(cardId, exports._wrapperDivPositions[cardId].opacity, opacityRangeMin, opacityRangeMax);
    ...
    const cardHTML = `
  	<div class="pokemon-cards">
	    <div class="pokemon-card">
	      ...
	      <div class="text-base">
	        HP: ${pokemon.ivs[pokemon_stat_1.Stat['HP']]}, ATK: ${pokemon.ivs[pokemon_stat_1.Stat['ATK']]}, DEF: ${pokemon.ivs[pokemon_stat_1.Stat['DEF']]}
	      </div>
	      <div class="text-base">
	        SPE: ${pokemon.ivs[pokemon_stat_1.Stat['SPD']]}, SPD: ${pokemon.ivs[pokemon_stat_1.Stat['SPDEF']]}, SPA: ${pokemon.ivs[pokemon_stat_1.Stat['SPATK']]}
	      </div>
...
function _createTypeEffectivenessWrapper(typeEffectivenesses) {
    const weaknessContainer = [...typeEffectivenesses.weaknesses]
        .map((value, index) => {
        const type = pokenode_ts_1.TYPES[value.toUpperCase()];
        return `
      ${(index + 1) % 3 === 1 ? '<div>' : ''}
...
function _updateWrapperDivPositions(oldDiv, divId) {
    exports._wrapperDivPositions[divId].top = parseInt(oldDiv.style.top);
    exports._wrapperDivPositions[divId].left = parseInt(oldDiv.style.left);
}
function _createWrapperDiv(divId) {
    ...
    newDiv.style.top = exports._wrapperDivPositions[divId].top.toString();
    newDiv.style.left = exports._wrapperDivPositions[divId].left.toString();
    newDiv.style.opacity = '' + Number(exports._wrapperDivPositions[divId].opacity) / 100;
    return newDiv;
}
...
exports._currentEnemyPage = 0;
exports._currentAllyPage = 0;
let _enemiesPokemon = [];
let _alliesPokemon = [];
let _weather;
// eslint-disable-next-line @typescript-eslint/no-extraneous-class
class HttpUtils {
    static updateFromMessage(message) {
        if (message instanceof update_allies_div_message_1.default) {
            if (!_.isEqual(_alliesPokemon, message.pokemon)) {
                _alliesPokemon = message.pokemon;
            }
        }
        if (message instanceof update_enemies_div_message_1.default) {
    ...
    static createCardsDiv(divId) {
        ...
        let pokemon;
        if (divId === 'enemies') {
            if (exports._currentEnemyPage >= _enemiesPokemon.length)
                exports._currentEnemyPage = 0;
            pokemon = _enemiesPokemon[exports._currentEnemyPage];
        }
        else {
            if (exports._currentAllyPage >= _alliesPokemon.length)
                exports._currentAllyPage = 0;
            pokemon = _alliesPokemon[exports._currentAllyPage];
        }
        ...
        /*
            ...
            */
        (_a = document.getElementById(cardObj.slider)) === null || _a === void 0 ? void 0 : _a.addEventListener('input', _changeOpacity);
        (_b = document.getElementById(buttonsObj.idUp)) === null || _b === void 0 ? void 0 : _b.addEventListener('click', _changePage);
        (_c = document.getElementById(buttonsObj.idDown)) === null || _c === void 0 ? void 0 : _c.addEventListener('click', _changePage);
        return newDiv;
    }
...
function _changeOpacity(e) {
    if (e.target instanceof HTMLInputElement) {
        ...
        const div = document.getElementById(divId);
        if (div) {
            exports._wrapperDivPositions[divId].opacity = parseInt(e.target.value);
...
function _changePage(click) {
    if (click.target instanceof HTMLButtonElement) {
        ...
        if (direction === 'up') {
            if (divId === 'enemies') {
                if (exports._currentEnemyPage > 0) {
                    exports._currentEnemyPage -= 1;
                }
                else {
                    exports._currentEnemyPage = _enemiesPokemon.length - 1;
                }
            }
            else if (divId === 'allies') {
                if (exports._currentAllyPage > 0) {
                    exports._currentAllyPage -= 1;
                }
                else {
                    exports._currentAllyPage = _alliesPokemon.length - 1;
                }
            }
        }
        else if (direction === 'down') {
            if (divId === 'enemies') {
                if (exports._currentEnemyPage + 1 < _enemiesPokemon.length) {
                    exports._currentEnemyPage += 1;
                }
                else {
                    exports._currentEnemyPage = 0;
                ...
                if (exports._currentAllyPage + 1 < _alliesPokemon.length) {
                    exports._currentAllyPage += 1;
                }
                else {
                    exports._currentAllyPage = 0;
...
const message_id_1 = __webpack_require__(3);
class UpdateAlliesDivMessage extends message_1.default {
    constructor(pokemon, weather, slotId) {
        super(message_id_1.default.UPDATE_ALLIES_DIV);
        this.type = message_id_1.default[message_id_1.default.UPDATE_ALLIES_DIV];
        this.pokemon = pokemon;
        this.weather = weather;
        this.slotId = slotId;
    }
    static [Symbol.hasInstance](instance) {
        return instance.id === message_id_1.default.UPDATE_ALLIES_DIV;
    }
}
exports["default"] = UpdateAlliesDivMessage;
...
const message_1 = __webpack_require__(2);
const message_id_1 = __webpack_require__(3);
class UpdateEnemiesDivMessage extends message_1.default {
    constructor(pokemon, weather, slotId) {
        super(message_id_1.default.UPDATE_ENEMIES_DIV);
        this.type = message_id_1.default[message_id_1.default.UPDATE_ENEMIES_DIV];
        this.pokemon = pokemon;
        this.weather = weather;
        this.slotId = slotId;
    }
    static [Symbol.hasInstance](instance) {
        return instance.id === message_id_1.default.UPDATE_ENEMIES_DIV;
    }
}
exports["default"] = UpdateEnemiesDivMessage;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const httputils_1 = __webpack_require__(19);
const localstorageutils_1 = __webpack_require__(23);
const update_allies_div_message_1 = __webpack_require__(21);
const update_enemies_div_message_1 = __webpack_require__(22);
const browser_1 = __webpack_require__(16);
// RogueDex is running! 렌더링
// HttpUtils.createTopBannerDiv();
httputils_1.HttpUtils.createWrapperDivs();
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    var _a;
    console.log('Got message:', message, 'from', sender, 'current message:', (_a = document.getElementById('touchControls')) === null || _a === void 0 ? void 0 : _a.getAttribute('data-ui-mode'));
    const uiMode = touchControlsElement === null || touchControlsElement === void 0 ? void 0 : touchControlsElement.getAttribute('data-ui-mode');
    console.log('Current ui mode: ', uiMode);
    if (message instanceof update_allies_div_message_1.default) {
        localstorageutils_1.LocalStorageUtils.slotId = message.slotId;
        if (uiMode === 'SAVE_SLOT')
            localstorageutils_1.LocalStorageUtils.cleanSessionData();
        if (uiMode === 'TITLE' || uiMode === 'SAVE_SLOT')
            return sendResponse({ success: true });
        httputils_1.HttpUtils.updateFromMessage(message);
        httputils_1.HttpUtils.createCardsDiv('allies');
        sendResponse({ success: true });
    }
    else if (message instanceof update_enemies_div_message_1.default) {
        localstorageutils_1.LocalStorageUtils.slotId = message.slotId;
        if (uiMode === 'SAVE_SLOT')
            localstorageutils_1.LocalStorageUtils.cleanSessionData();
        if (uiMode === 'TITLE' || uiMode === 'SAVE_SLOT')
            return sendResponse({ success: true });
        httputils_1.HttpUtils.updateFromMessage(message);
        httputils_1.HttpUtils.createCardsDiv('enemies');
        sendResponse({ success: true });
    }
});
    ...
    const observer = new MutationObserver(mutations => {
        mutations.forEach(async (mutation) => {
            ...
            if (newValue === 'MESSAGE' || newValue === 'COMMAND' || newValue === 'CONFIRM') {
                browser_1.browserApi.runtime.sendMessage({
                    type: 'BG_GET_SAVEDATA',
                    data: localstorageutils_1.LocalStorageUtils.getCurrentSessionData(localStorage),
                    slotId: localstorageutils_1.LocalStorageUtils.slotId,
                });
            }
            else {
                if (newValue === 'SAVE_SLOT') {
                    //TODO: Perhaps observe changes in local storage?
                    setTimeout(localstorageutils_1.LocalStorageUtils.cleanSessionData, 1000);
                }
                httputils_1.HttpUtils.deleteWrapperDivs();
            }
        });
    });
